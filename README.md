...
`LLAMA_3_2_1B_INST_Q4_0` model (a few hundred MB); the UI will show
...
_![QVAC Offline AI Assistant screenshot](screenshot.png)_

_(Add a screenshot or screen recording of the app answering a question here
before submitting.)_

## Troubleshooting

**`RPC_INIT_TIMEOUT` / `WORKER_STARTUP_FAILED`**
